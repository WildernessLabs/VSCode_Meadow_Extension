...
namespace Meadow.Debugging.DAP.Deployment
{
    /// <summary>
    /// Adapts IDeploymentCallbacks to IDebugEventEmitter.
    /// Bridges deployment events to debug event emission for any DAP-compliant IDE.
    /// </summary>
    public class DeploymentCallbackAdapter : IDeploymentCallbacks
    {
